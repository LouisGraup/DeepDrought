...
param = [ # store unmodified parameter ranges here for posterity
    ...
    ("INFEXP", 0.1, 0.4), # infiltration exponent (0, 0.9)
    ("IDEPTH_m", 0.5, 0.7), # infiltration depth (m) (0.05, 1.0)
    # meteo parameters
    ("ALB", 0.17, 0.28), # surface albedo (0.1, 0.3)
    ("ALBSN", 0.45, 0.7), # snow surface albedo (0.4, 0.8)
    # soil parameters
    ("RSSA", 200, 400), # soil resistance (20, 1000)
    ("ths1", 0.25, 0.4), # theta_sat (0.15, 0.6)
    ("thr1", 0.01, 0.1), # theta_res (0.0, 0.1)
    ("ksat1", 200, 3100), # k_sat (100, 5000)
    ("alpha1", 10, 18), # alpha (2, 25)
    ("npar1", 1.2, 1.23), # n (1.15, 1.3)
    ("tort1", 2, 8), # tortuosity (−10, 10)
    ("ths2", 0.4, 0.55), # theta_sat (0.15, 0.6)
    ("thr2", 0.03, 0.09), # theta_res (0.0, 0.1)
    ("ksat2", 1000, 4000), # k_sat (100, 5000)
    ("alpha2", 9, 20), # alpha (2, 25)
    ("npar2", 1.15, 1.27), # n (1.15, 1.3)
    ("tort2", -4, 0), # tortuosity (−10, 10)
    ("ths3", 0.5, 0.6), # theta_sat (0.15, 0.6)
    ("thr3", 0.0, 0.08), # theta_res (0.0, 0.1)
    ("ksat3", 1500, 3300), # k_sat (100, 5000)
    ("alpha3", 2, 5), # alpha (2, 25)
    ("npar3", 1.17, 1.23), # n (1.15, 1.3)
    ("tort3", -9.0, -6.9), # tortuosity (−10, 10)
    # plant parameters
    ("CINTRL", 0.1, 0.17), # interception storage capacity per unit LAI (0.05, 0.75)
    ("FRINTLAI", 0.02, 0.03), # interception catch fraction per unit LAI (0.02, 0.2)
    ("GLMAX", 0.004, 0.005), # stomatal conductance (0.001, 0.02)
    ("CVPD", 0.5, 0.6), # vpd sensitivity (0.5, 3)
    ("R5", 60, 100), # radiation sensitivity (50, 200)
    ("T1", 8.5, 11.0), # low temperature threshold (5, 15)
    ("T2", 22, 27), # high temperature threshold (20, 35)
    ("PSICR", -2.6, -1.0), # critical water potential (-3, -1)
    ("FXYLEM", 0.1, 0.4), # aboveground xylem fraction (0.1, 0.5)
    ("MXKPL", 15.0, 30.0), # maximum plant conductivity (7, 30)
    ...
    ("MAXROOTDEPTH", -1.3, -0.9), # max rooting depth (-1.5, -0.8)
    ("BETAROOT", 0.91, 0.975) # beta root coefficient (0.9, 0.999)
];
