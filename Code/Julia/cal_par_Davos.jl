...
param = [ # store unmodified parameter ranges here for posterity
    ...
    ("ksat1", -0.3, 0.25), # additive factor on log10(k_sat) (-0.5, 0.5)
    ...
    ("FRINTLAI", 0.02, 0.08), # interception catch fraction per unit LAI (0.02, 0.2)
    ("GLMAX", 0.003, 0.0045), # stomatal conductance (0.001, 0.02)
    ("CVPD", 0.5, 1.1), # vpd sensitivity (0.5, 3)
