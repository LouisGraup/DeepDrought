...
param = [ # store unmodified parameter ranges here for posterity
    ...
    ("alpha3", 2, 15), # alpha (2, 25)
    ("npar3", 1.17, 1.28), # n (1.15, 1.3)
    ("tort3", -9, -5), # tortuosity (−10, 10)
    # plant parameters
    ...
    ("GLMAX", 0.003, 0.006), # stomatal conductance (0.001, 0.02)
    ("CVPD", 0.5, 1.5), # vpd sensitivity (0.5, 3)
    ("R5", 60, 170), # radiation sensitivity (50, 200)
    ("T1", 5, 12), # low temperature threshold (5, 15)
    ("T2", 20, 28), # high temperature threshold (20, 35)
