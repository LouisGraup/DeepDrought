...
param = [ # store unmodified parameter ranges here for posterity
    ...
    ("ALBSN", 0.4, 0.7), # snow surface albedo (0.4, 0.8)
    # soil parameters
    ("RSSA", 20, 750), # soil resistance (20, 1000)
    ("ths1", 0.15, 0.6), # theta_sat (0.15, 0.6)
    ("thr1", 0.01, 0.1), # theta_res (0.0, 0.1)
    ("ksat1", 200, 5000), # k_sat (100, 5000)
    ("alpha1", 5, 25), # alpha (2, 25)
    ("npar1", 1.2, 1.3), # n (1.15, 1.3)
    ("tort1", -5, 8), # tortuosity (−10, 10)
    ("ths2", 0.3, 0.6), # theta_sat (0.15, 0.6)
    ("thr2", 0.0, 0.1), # theta_res (0.0, 0.1)
    ("ksat2", 1000, 5000), # k_sat (100, 5000)
    ("alpha2", 2, 20), # alpha (2, 25)
    ("npar2", 1.15, 1.3), # n (1.15, 1.3)
    ("tort2", -10, 5), # tortuosity (−10, 10)
    ("ths3", 0.3, 0.6), # theta_sat (0.15, 0.6)
    ("thr3", 0.0, 0.1), # theta_res (0.0, 0.1)
    ("ksat3", 1000, 4000), # k_sat (100, 5000)
    ("alpha3", 2, 22), # alpha (2, 25)
    ("npar3", 1.15, 1.28), # n (1.15, 1.3)
    ("tort3", -9, -2), # tortuosity (−10, 10)
    # plant parameters
    ("CINTRL", 0.1, 0.33), # interception storage capacity per unit LAI (0.05, 0.75)
    ("FRINTLAI", 0.02, 0.06), # interception catch fraction per unit LAI (0.02, 0.2)
    ("GLMAX", 0.002, 0.007), # stomatal conductance (0.001, 0.02)
    ("CVPD", 0.5, 1.8), # vpd sensitivity (0.5, 3)
    ("R5", 50, 200), # radiation sensitivity (50, 200)
    ("T1", 5, 14), # low temperature threshold (5, 15)
    ("T2", 20, 29), # high temperature threshold (20, 35)
    ("PSICR", -2.8, -1.0), # critical water potential (-3, -1)
    ...
    ("MAXROOTDEPTH", -1.3, -0.8), # max rooting depth (-1.5, -0.8)
