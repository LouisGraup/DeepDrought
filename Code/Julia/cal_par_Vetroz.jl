...
param = [
    ...
    ("ths1", 0.3, 0.6), # theta_sat (0.2, 0.6)
    ...
    ("ths2", 0.28, 0.6), # theta_sat (0.2, 0.6)
    ...
    ("ths3", 0.25, 0.6), # theta_sat (0.2, 0.6)
    ("thr3", 0.0, 0.15), # theta_res (0.0, 0.2)
    ("ksat3", -0.4, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.6, 1.5), # multiplier on alpha (0.5, 1.5)
    ("npar3", 1.2, 1.3), # n (1.2, 1.3)
    ("ths4", 0.2, 0.5), # theta_sat (0.2, 0.6)
    ("thr4", 0.0, 0.15), # theta_res (0.0, 0.2)
    ("ksat4", -0.4, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha4", 0.5, 1.3), # multiplier on alpha (0.5, 1.5)
    ("npar4", 1.2, 1.3), # n (1.2, 1.3)
    ("ths5", 0.2, 0.45), # theta_sat (0.2, 0.6)
    ("thr5", 0.05, 0.2), # theta_res (0.0, 0.2)
    ("ksat5", 0.0, 0.7), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha5", 0.4, 1.0), # multiplier on alpha (0.5, 1.5)
