...
param = [
    ...
    ("ksat4", -0.2, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha4", 0.5, 1.5), # multiplier on alpha (0.5, 1.5)
    ("npar4", 1.2, 1.3), # n (1.2, 1.3)
    ("ths5", 0.2, 0.5), # theta_sat (0.2, 0.6)
    ("thr5", 0.01, 0.1), # theta_res (0.0, 0.1)
    ("ksat5", 0.2, 0.6), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha5", 0.5, 0.95), # multiplier on alpha (0.5, 1.5)
