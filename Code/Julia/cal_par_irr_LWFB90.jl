...
param = [
    # hydro parameters
    ("DRAIN", 0.0, 0.5), # drainage (0, 1)
    ("INFEXP", 0.7, 0.9), # infiltration exponent (0, 0.9)
    ("IDEPTH_m", 0.8, 1.0), # infiltration depth (m) (0.05, 1.0)
    # meteo parameters
    #("ALB", 0.15, 0.3), # surface albedo (0.1, 0.3)
    #("ALBSN", 0.4, 0.8), # snow surface albedo (0.4, 0.8)
    # soil parameters
    ("RSSA", 300, 600), # soil resistance (20, 1000)
    ("ths1", 0.3, 0.5), # theta_sat (0.15, 0.6)
    ("thr1", 0.01, 0.035), # theta_res (0.0, 0.1)
    ("ksat1", -0.3, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha1", 0.5, 1.2), # multiplier on alpha (0.5, 1.5)
    ("npar1", 1.2, 1.29), # n (1.15, 1.3)
    ("ths2", 0.15, 0.18), # theta_sat (0.15, 0.6)
    ("thr2", 0.01, 0.04), # theta_res (0.0, 0.1)
    ("ksat2", -0.5, -0.2), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha2", 0.9, 1.4), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.17, 1.25), # n (1.15, 1.3)
    ("ths3", 0.15, 0.17), # theta_sat (0.15, 0.6)
    ("thr3", 0.02, 0.055), # theta_res (0.0, 0.1)
    ("ksat3", 0.05, 0.3), # additive factor on log10(k_sat) (-0.5, 0.5)
    ...
    ("PSICR", -1.4, -1.0), # critical water potential (-3, -1)
    ("FXYLEM", 0.15, 0.45), # aboveground xylem fraction (0.1, 0.5)
    ("MXKPL", 7.0, 25.0), # maximum plant conductivity (7, 30)
    #("MXRTLN", 2000, 4000), # maximum root length (2000, 4000)
    ("VXYLEM_mm", 5.0, 75.0), # xylem volume (5, 80)
    ("DISPERSIVITY_mm", 35.0, 48.0), # dispersivity coefficient (30, 50)
    ("MAXROOTDEPTH", -2.0, -0.9), # max rooting depth (-2, -0.8)
    ("BETAROOT", 0.9, 0.96) # beta root coefficient (0.9, 0.999)
];
