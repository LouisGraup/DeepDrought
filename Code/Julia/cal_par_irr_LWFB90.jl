...
param = [ # store unmodified parameter ranges here for posterity
    # hydro parameters
    ("DRAIN", 0.2, 0.4), # drainage (0, 1)
    ("INFEXP", 0.45, 0.65), # infiltration exponent (0, 0.9)
    ...
    ("alpha1", 0.9, 1.2), # multiplier on alpha (0.5, 1.5)
    ("npar1", 1.22, 1.29), # n (1.15, 1.3)
    ("ths2", 0.18, 0.22), # theta_sat (0.15, 0.6)
    ("thr2", 0.025, 0.04), # theta_res (0.0, 0.1)
    ("ksat2", -0.25, 0.0), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha2", 0.8, 1.1), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.21, 1.275), # n (1.15, 1.3)
    ("ths3", 0.195, 0.21), # theta_sat (0.15, 0.6)
    ("thr3", 0.0, 0.015), # theta_res (0.0, 0.1)
    ("ksat3", 0.15, 0.42), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.8, 1.05), # multiplier on alpha (0.5, 1.5)
    ("npar3", 1.24, 1.28), # n (1.15, 1.3)
    # plant parameters
    #("CINTRL", 0.1, 0.75), # interception storage capacity per unit LAI (0.05, 0.75)
    ("FRINTLAI", 0.165, 0.18), # interception catch fraction per unit LAI (0.02, 0.2)
    ("GLMAX", 0.008, 0.0095), # stomatal conductance (0.001, 0.02)
    ("CVPD", 1.9, 2.5), # vpd sensitivity (0.5, 3)
    ("R5", 90, 130), # radiation sensitivity (50, 200)
    ...
    ("BETAROOT", 0.92, 0.95) # beta root coefficient (0.9, 0.999)
];
