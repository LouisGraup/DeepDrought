...
param = [
    ...
    ("INFEXP", 0.6, 0.8), # infiltration exponent (0, 0.9)
    ...
    # soil parameters
    ("RSSA", 150, 350), # soil resistance (1, 1500)
    ("ths1", 1.1, 1.35), # multiplier on theta_sat (0.5, 1.5)
    ("ksat1", -0.1, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("ths2", 1.3, 1.35), # multiplier on theta_sat (0.5, 1.5)
    ("ksat2", -0.1, 0.25), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("ths3", 1.4, 1.45), # multiplier on theta_sat (0.5, 1.5)
    ...
    ("GLMAX", 0.018, 0.022), # stomatal conductance (0.001, 0.03)
    ("CVPD", 2.1, 2.7), # vpd sensitivity (1, 3)
    ...
    ("MXKPL", 18.0, 24.0), # maximum plant conductivity (1, 30)
    ...
    ("MAXROOTDEPTH", -2.0, -1.2), # max rooting depth (-5, -0.5)
    ("BETAROOT", 0.965, 0.98) # beta root coefficient (0.8, 1.0)
];
