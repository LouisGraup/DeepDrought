...
param = [ # store unmodified parameter ranges here for posterity
    ...
    # soil parameters
    ("RSSA", 40, 700), # soil resistance (20, 1000)
    ...
    ("alpha2", 1.0, 1.5), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.2, 1.3), # n (1.15, 1.3)
    ("ths3", 0.15, 0.2), # theta_sat (0.15, 0.6)
    ("thr3", 0.0, 0.05), # theta_res (0.0, 0.1)
    ("ksat3", -0.3, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.65, 1.5), # multiplier on alpha (0.5, 1.5)
