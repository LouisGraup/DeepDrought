...
param = [
    ...
    ("ths3", 1.3, 1.5), # multiplier on theta_sat (0.5, 1.5)
    ...
    ("MXKPL", 15.0, 30.0), # maximum plant conductivity (1, 30)
    ("MXRTLN", 100, 4000), # maximum root length (100, 6000)
    #("VXYLEM_mm", 1.0, 100.0), # xylem volume (1, 100)
    #("DISPERSIVITY_mm", 1.0, 100.0), # dispersivity coefficient (1, 100)
    ("MAXROOTDEPTH", -2, -0.6), # max rooting depth (-5, -0.5)
    ("BETAROOT", 0.95, 1.0) # beta root coefficient (0.8, 1.0)
];
