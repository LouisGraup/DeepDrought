...
param = [
    ...
    ("GLMAX", 0.02, 0.026), # stomatal conductance (0.001, 0.03)
    ("CVPD", 2.4, 3), # vpd sensitivity (1, 3)
    ("R5", 190, 240), # radiation sensitivity (50, 400)
    #("T1", 6, 12), # low temperature threshold (5, 15)
    #("T2", 20, 35), # high temperature threshold (20, 35)
    ("PSICR", -1.06, -1.0), # critical water potential (-4, -1)
    ("FXYLEM", 0.3, 0.55), # aboveground xylem fraction (0.2, 0.8)
    ("MXKPL", 25.0, 30.0), # maximum plant conductivity (1, 30)
    ...
    ("BETAROOT", 0.963, 0.973) # beta root coefficient (0.8, 1.0)
];
