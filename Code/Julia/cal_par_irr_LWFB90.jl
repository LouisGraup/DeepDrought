...
param = [ # store unmodified parameter ranges here for posterity
    ...
    # soil parameters
    ("RSSA", 20, 700), # soil resistance (20, 1000)
    ("ths1", 0.25, 0.5), # theta_sat (0.15, 0.6)
    ...
    ("ths2", 0.15, 0.35), # theta_sat (0.15, 0.6)
    ...
    ("ths3", 0.15, 0.3), # theta_sat (0.15, 0.6)
    ("thr3", 0.0, 0.05), # theta_res (0.0, 0.1)
    ("ksat3", -0.4, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.6, 1.5), # multiplier on alpha (0.5, 1.5)
    ("npar3", 1.19, 1.3), # n (1.15, 1.3)
    # plant parameters
    ...
    ("GLMAX", 0.001, 0.015), # stomatal conductance (0.001, 0.02)
