...
param = [ # store unmodified parameter ranges here for posterity
    # hydro parameters
    ("DRAIN", 0.1, 0.85), # drainage (0, 1)
    ("INFEXP", 0.1, 0.9), # infiltration exponent (0, 0.9)
    ("IDEPTH_m", 0.3, 1.0), # infiltration depth (m) (0.05, 1.0)
    # meteo parameters
    ...
    ("alpha1", 0.8, 1.5), # multiplier on alpha (0.5, 1.5)
    ("npar1", 1.15, 1.29), # n (1.15, 1.3)
    ("ths2", 0.15, 0.25), # theta_sat (0.15, 0.6)
    ("thr2", 0.0, 0.08), # theta_res (0.0, 0.1)
    ("ksat2", -0.5, 0.2), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha2", 0.6, 1.5), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.16, 1.29), # n (1.15, 1.3)
    ("ths3", 0.15, 0.25), # theta_sat (0.15, 0.6)
    ("thr3", 0.0, 0.05), # theta_res (0.0, 0.1)
    ("ksat3", -0.25, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.6, 1.5), # multiplier on alpha (0.5, 1.5)
    ...
    ("GLMAX", 0.001, 0.012), # stomatal conductance (0.001, 0.02)
    ...
    ("MXKPL", 7.0, 24.0), # maximum plant conductivity (7, 30)
    ...
    ("MAXROOTDEPTH", -2.0, -1.0), # max rooting depth (-2, -0.8)
    ("BETAROOT", 0.91, 0.97) # beta root coefficient (0.9, 0.999)
];
