...
param = [
    ...
    # soil parameters
    ("RSSA", 100, 250), # soil resistance (1, 1500)
    ...
    ("ths3", 1.42, 1.46), # multiplier on theta_sat (0.5, 1.5)
    ...
    ("CVPD", 2.5, 3), # vpd sensitivity (1, 3)
    ...
    ("BETAROOT", 0.965, 0.973) # beta root coefficient (0.8, 1.0)
];
