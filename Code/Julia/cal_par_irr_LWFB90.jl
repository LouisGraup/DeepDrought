...
param = [ # store unmodified parameter ranges here for posterity
    ...
    ("ths1", 0.3, 0.45), # theta_sat (0.15, 0.6)
    ...
    ("npar1", 1.15, 1.25), # n (1.15, 1.3)
    ("ths2", 0.18, 0.25), # theta_sat (0.15, 0.6)
    ("thr2", 0.005, 0.04), # theta_res (0.0, 0.1)
    ("ksat2", -0.4, 0.0), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha2", 1.0, 1.3), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.21, 1.28), # n (1.15, 1.3)
    ("ths3", 0.15, 0.18), # theta_sat (0.15, 0.6)
    ("thr3", 0.01, 0.035), # theta_res (0.0, 0.1)
    ("ksat3", 0.2, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.9, 1.4), # multiplier on alpha (0.5, 1.5)
    ("npar3", 1.21, 1.28), # n (1.15, 1.3)
    # plant parameters
    ...
    ("GLMAX", 0.005, 0.009), # stomatal conductance (0.001, 0.02)
    ("CVPD", 0.5, 2.8), # vpd sensitivity (0.5, 3)
    ("R5", 70, 170), # radiation sensitivity (50, 200)
    ...
    ("MXKPL", 7.0, 13.0), # maximum plant conductivity (7, 30)
