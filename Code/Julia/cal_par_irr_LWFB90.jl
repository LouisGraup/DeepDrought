...
param = [
    ...
    ("IDEPTH_m", 0.6, 1.0), # infiltration depth (m) (0.05, 1.0)
    # meteo parameters
    ...
    ("BETAROOT", 0.9, 0.97) # beta root coefficient (0.9, 0.999)
];
