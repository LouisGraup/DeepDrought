...
param = [
    # hydro parameters
    ("DRAIN", 0.0, 0.4), # drainage (0, 1)
    ("INFEXP", 0.6, 0.9), # infiltration exponent (0, 0.9)
    ("IDEPTH_m", 0.5, 0.7), # infiltration depth (m) (0.05, 0.5)
    # meteo parameters
    ...
    ("ths3", 1.35, 1.45), # multiplier on theta_sat (0.5, 1.5)
    ("ksat3", 0.25, 0.4), # additive factor on log10(k_sat) (-0.5, 0.5)
    # plant parameters
    ...
    ("GLMAX", 0.018, 0.025), # stomatal conductance (0.001, 0.03)
    ...
    ("FXYLEM", 0.3, 0.7), # aboveground xylem fraction (0.2, 0.8)
    ...
    ("MAXROOTDEPTH", -2.0, -1.1), # max rooting depth (-5, -0.5)
