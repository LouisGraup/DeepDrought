...
param = [
    ...
    ("ths2", 0.3, 0.8), # multiplier on theta_sat (0.5, 1.5)
    ("ksat2", -0.5, 0.1), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("ths3", 0.25, 0.7), # multiplier on theta_sat (0.5, 1.5)
    ...
    ("CVPD", 1.0, 2.8), # vpd sensitivity (1, 3)
    ("R5", 60, 390), # radiation sensitivity (50, 400)
    ...
    ("MXKPL", 1.0, 25.0), # maximum plant conductivity (1, 30)
    ...
    ("BETAROOT", 0.9, 0.99) # beta root coefficient (0.8, 1.0)
];
