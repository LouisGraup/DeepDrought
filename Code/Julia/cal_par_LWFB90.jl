...
param = [
    ...
    # soil parameters
    ("RSSA", 200, 250), # soil resistance (20, 1000)
    ...
    ("ksat2", -0.1, 0.15), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha2", 1.1, 1.4), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.19, 1.24), # n (1.15, 1.3)
    ("ths3", 0.15, 0.175), # theta_sat (0.15, 0.6)
    ("thr3", 0.03, 0.042), # theta_res (0.0, 0.1)
    ("ksat3", 0.0, 0.35), # additive factor on log10(k_sat) (-0.5, 0.5)
    ...
    ("CVPD", 0.6, 1.1), # vpd sensitivity (0.5, 3)
    ("R5", 100, 170), # radiation sensitivity (50, 200)
    ...
    ("MXKPL", 8.0, 17.0), # maximum plant conductivity (7, 30)
