...
param = [
    ...
    ("GLMAX", 0.005, 0.027), # stomatal conductance (0.001, 0.03)
    ("CVPD", 1, 3), # vpd sensitivity (1, 3)
    ("R5", 125, 400), # radiation sensitivity (50, 400)
    #("T1", 6, 12), # low temperature threshold (5, 15)
    #("T2", 20, 35), # high temperature threshold (20, 35)
    ("PSICR", -2.5, -1.2), # critical water potential (-4, -1)
    ("FXYLEM", 0.2, 0.7), # aboveground xylem fraction (0.2, 0.8)
    ("MXKPL", 5.0, 30.0), # maximum plant conductivity (1, 30)
    ...
    ("BETAROOT", 0.95, 0.985) # beta root coefficient (0.8, 1.0)
];
