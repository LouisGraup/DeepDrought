...
param = [
    ...
    ("INFEXP", 0.25, 0.9), # infiltration exponent (0, 0.9)
    ("IDEPTH_m", 0.4, 1.0), # infiltration depth (m) (0.05, 0.5)
    # meteo parameters
    #("ALB", 0.15, 0.3), # surface albedo (0.1, 0.3)
    #("ALBSN", 0.4, 0.8), # snow surface albedo (0.4, 0.8)
    # soil parameters
    ("RSSA", 100, 1500), # soil resistance (1, 1500)
    ("ths1", 0.85, 1.4), # multiplier on theta_sat (0.5, 1.5)
    ("ksat1", -0.4, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("ths2", 1.2, 1.4), # multiplier on theta_sat (0.5, 1.5)
    ("ksat2", 0.0, 0.4), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("ths3", 1.25, 1.45), # multiplier on theta_sat (0.5, 1.5)
    ("ksat3", 0.0, 0.4), # additive factor on log10(k_sat) (-0.5, 0.5)
    # plant parameters
    ...
    ("GLMAX", 0.006, 0.025), # stomatal conductance (0.001, 0.03)
    ("CVPD", 1.1, 3), # vpd sensitivity (1, 3)
    ("R5", 150, 400), # radiation sensitivity (50, 400)
    ...
    ("FXYLEM", 0.2, 0.7), # aboveground xylem fraction (0.2, 0.8)
    ("MXKPL", 5.0, 26.0), # maximum plant conductivity (1, 30)
    ...
    ("MAXROOTDEPTH", -1.9, -1.0), # max rooting depth (-5, -0.5)
    ("BETAROOT", 0.955, 0.98) # beta root coefficient (0.8, 1.0)
];
