...
param = [
    ...
    ("GLMAX", 0.009, 0.011), # stomatal conductance (0.001, 0.03)
    ...
    ("PSICR", -1.25, -1.1), # critical water potential (-4, -1)
    ("FXYLEM", 0.3, 0.8), # aboveground xylem fraction (0.2, 0.8)
    ("MXKPL", 12.0, 17.0), # maximum plant conductivity (1, 30)
    ...
    ("BETAROOT", 0.967, 0.98) # beta root coefficient (0.8, 1.0)
];
