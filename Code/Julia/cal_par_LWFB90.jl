...
param = [
    ...
    # soil parameters
    ("RSSA", 200, 300), # soil resistance (20, 1000)
    ("ths1", 0.3, 0.4), # theta_sat (0.15, 0.6)
    ("thr1", 0.02, 0.045), # theta_res (0.0, 0.1)
    ("ksat1", 0.2, 0.4), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha1", 0.5, 0.75), # multiplier on alpha (0.5, 1.5)
    ("npar1", 1.23, 1.26), # n (1.15, 1.3)
    ("ths2", 0.16, 0.205), # theta_sat (0.15, 0.6)
    ...
    ("thr3", 0.03, 0.06), # theta_res (0.0, 0.1)
