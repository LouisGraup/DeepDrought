...
param = [
    ...
    # soil parameters
    ("RSSA", 240, 350), # soil resistance (20, 1000)
    ("ths1", 0.575, 0.6), # theta_sat (0.15, 0.6)
    ...
    ("npar1", 1.21, 1.245), # n (1.15, 1.3)
    ("ths2", 0.205, 0.23), # theta_sat (0.15, 0.6)
    ...
    ("npar2", 1.22, 1.245), # n (1.15, 1.3)
    ("ths3", 0.22, 0.24), # theta_sat (0.15, 0.6)
    ("thr3", 0.0, 0.0035), # theta_res (0.0, 0.1)
    ("ksat3", 0.0, 0.25), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.7, 0.95), # multiplier on alpha (0.5, 1.5)
    ...
    ("GLMAX", 0.005, 0.00655), # stomatal conductance (0.001, 0.02)
    ("CVPD", 1.5, 2.2), # vpd sensitivity (0.5, 3)
    ("R5", 80, 130), # radiation sensitivity (50, 200)
    #("T1", 6, 12), # low temperature threshold (5, 15)
    #("T2", 20, 35), # high temperature threshold (20, 35)
    ("PSICR", -1.5, -1.46), # critical water potential (-3, -1)
    ...
    ("MAXROOTDEPTH", -2.0, -1.55), # max rooting depth (-2, -0.8)
