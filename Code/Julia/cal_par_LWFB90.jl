...
param = [
    ...
    ("GLMAX", 0.008, 0.013), # stomatal conductance (0.001, 0.03)
    ...
    ("MXKPL", 12.0, 20.0), # maximum plant conductivity (1, 30)
    ...
    ("BETAROOT", 0.963, 0.98) # beta root coefficient (0.8, 1.0)
];
