...
param = [
    ...
    ("ths1", 0.58, 0.6), # theta_sat (0.15, 0.6)
    ("thr1", 0.01, 0.03), # theta_res (0.0, 0.1)
    ("ksat1", -0.3, 0.2), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha1", 0.5, 0.75), # multiplier on alpha (0.5, 1.5)
    ("npar1", 1.21, 1.245), # n (1.15, 1.3)
    ("ths2", 0.21, 0.23), # theta_sat (0.15, 0.6)
    ("thr2", 0.01, 0.0175), # theta_res (0.0, 0.1)
    ("ksat2", -0.2, -0.05), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha2", 0.9, 1.2), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.22, 1.24), # n (1.15, 1.3)
    ("ths3", 0.22, 0.235), # theta_sat (0.15, 0.6)
    ("thr3", 0.0, 0.0025), # theta_res (0.0, 0.1)
    ("ksat3", 0.1, 0.25), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.7, 0.9), # multiplier on alpha (0.5, 1.5)
    ("npar3", 1.28, 1.3), # n (1.15, 1.3)
    # plant parameters
    ...
    ("PSICR", -1.5, -1.47), # critical water potential (-3, -1)
    ...
    ("MAXROOTDEPTH", -2.0, -1.7), # max rooting depth (-2, -0.8)
    ("BETAROOT", 0.965, 0.971) # beta root coefficient (0.9, 0.999)
];
