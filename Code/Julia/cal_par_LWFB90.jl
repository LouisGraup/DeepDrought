...
param = [
    ...
    ("INFEXP", 0.6, 0.9), # infiltration exponent (0, 0.9)
    ...
    # soil parameters
    ("RSSA", 180, 400), # soil resistance (20, 1000)
    ...
    ("npar3", 1.25, 1.3), # n (1.15, 1.3)
    # plant parameters
    #("CINTRL", 0.1, 0.75), # interception storage capacity per unit LAI (0.05, 0.75)
    ("FRINTLAI", 0.12, 0.2), # interception catch fraction per unit LAI (0.02, 0.2)
    ("GLMAX", 0.0045, 0.007), # stomatal conductance (0.001, 0.02)
    ("CVPD", 1.5, 2.5), # vpd sensitivity (0.5, 3)
    ...
    ("MAXROOTDEPTH", -2.0, -1.3), # max rooting depth (-2, -0.8)
