...
param = [
    ...
    # soil parameters
    ("RSSA", 200, 1000), # soil resistance (20, 1000)
    ("ths1", 0.15, 0.5), # theta_sat (0.15, 0.6)
    ("thr1", 0.0, 0.08), # theta_res (0.0, 0.1)
    ("ksat1", -0.4, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha1", 0.5, 1.5), # multiplier on alpha (0.5, 1.5)
    ("npar1", 1.15, 1.26), # n (1.15, 1.3)
    ("ths2", 0.15, 0.3), # theta_sat (0.15, 0.6)
    ("thr2", 0.005, 0.07), # theta_res (0.0, 0.1)
    ...
    ("thr3", 0.0, 0.09), # theta_res (0.0, 0.1)
    ("ksat3", -0.5, 0.35), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.7, 1.5), # multiplier on alpha (0.5, 1.5)
    ("npar3", 1.16, 1.3), # n (1.15, 1.3)
    # plant parameters
    ...
    ("GLMAX", 0.001, 0.004), # stomatal conductance (0.001, 0.02)
    ...
    ("DISPERSIVITY_mm", 32.0, 48.0), # dispersivity coefficient (30, 50)
