...
param = [
    # hydro parameters
    ("DRAIN", 0.5, 0.75), # drainage (0, 1)
    ("INFEXP", 0.3, 0.75), # infiltration exponent (0, 0.9)
    ("IDEPTH_m", 0.1, 0.6), # infiltration depth (m) (0.05, 1.0)
    # meteo parameters
    #("ALB", 0.15, 0.3), # surface albedo (0.1, 0.3)
    #("ALBSN", 0.4, 0.8), # snow surface albedo (0.4, 0.8)
    # soil parameters
    ("RSSA", 200, 500), # soil resistance (20, 1000)
    ("ths1", 0.25, 0.4), # theta_sat (0.15, 0.6)
    ("thr1", 0.02, 0.05), # theta_res (0.0, 0.1)
    ("ksat1", 0.1, 0.4), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha1", 0.5, 0.9), # multiplier on alpha (0.5, 1.5)
    ("npar1", 1.2, 1.26), # n (1.15, 1.3)
    ("ths2", 0.16, 0.21), # theta_sat (0.15, 0.6)
    ("thr2", 0.009, 0.03), # theta_res (0.0, 0.1)
    ("ksat2", -0.4, 0.15), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha2", 1.0, 1.42), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.16, 1.24), # n (1.15, 1.3)
    ("ths3", 0.15, 0.18), # theta_sat (0.15, 0.6)
    ("thr3", 0.03, 0.07), # theta_res (0.0, 0.1)
    ("ksat3", -0.1, 0.35), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.85, 1.4), # multiplier on alpha (0.5, 1.5)
    ...
    ("GLMAX", 0.0023, 0.004), # stomatal conductance (0.001, 0.02)
    ("CVPD", 0.5, 1.6), # vpd sensitivity (0.5, 3)
    ...
    ("MXKPL", 8.0, 21.0), # maximum plant conductivity (7, 30)
    #("MXRTLN", 2000, 4000), # maximum root length (2000, 4000)
    ("VXYLEM_mm", 10.0, 60.0), # xylem volume (5, 80)
    ("DISPERSIVITY_mm", 37.5, 45.5), # dispersivity coefficient (30, 50)
    ("MAXROOTDEPTH", -2.0, -0.8), # max rooting depth (-2, -0.8)
    ("BETAROOT", 0.96, 0.98) # beta root coefficient (0.9, 0.999)
];
