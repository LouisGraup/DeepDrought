...
param = [
    ...
    ("npar1", 1.19, 1.3), # n (1.15, 1.3)
    ("ths2", 0.2, 0.3), # theta_sat (0.15, 0.6)
    ("thr2", 0.01, 0.05), # theta_res (0.0, 0.1)
    ...
    ("ths3", 0.12, 0.25), # theta_sat (0.15, 0.6)
    ...
    ("GLMAX", 0.002, 0.02), # stomatal conductance (0.001, 0.02)
