...
param = [
    ...
    ("alpha2", 0.6, 1.3), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.17, 1.29), # n (1.15, 1.3)
    ("ths3", 0.15, 0.28), # theta_sat (0.15, 0.6)
    ...
    ("GLMAX", 0.002, 0.018), # stomatal conductance (0.001, 0.02)
    ...
    ("MAXROOTDEPTH", -1.9, -0.8), # max rooting depth (-2, -0.8)
    ("BETAROOT", 0.93, 0.99) # beta root coefficient (0.9, 0.999)
];
