...
param = [
    # hydro parameters
    ("DRAIN", 0.1, 0.5), # drainage (0, 1)
    ("INFEXP", 0.3, 0.7), # infiltration exponent (0, 0.9)
    ...
    ("alpha1", 0.6, 1.2), # multiplier on alpha (0.5, 1.5)
    ...
    ("GLMAX", 0.005, 0.0085), # stomatal conductance (0.001, 0.02)
    ("CVPD", 0.6, 1.7), # vpd sensitivity (0.5, 3)
    ("R5", 60, 160), # radiation sensitivity (50, 200)
    #("T1", 6, 12), # low temperature threshold (5, 15)
    #("T2", 20, 35), # high temperature threshold (20, 35)
    ("PSICR", -1.6, -1.45), # critical water potential (-3, -1)
    ...
    ("BETAROOT", 0.96, 0.985) # beta root coefficient (0.9, 0.999)
];
