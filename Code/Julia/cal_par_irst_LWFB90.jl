...
param = [
    ...
    ("INFEXP", 0.4, 0.8), # infiltration exponent (0, 0.9)
    ("IDEPTH_m", 0.25, 0.4), # infiltration depth (m) (0.05, 1.0)
    # meteo parameters
    #("ALB", 0.15, 0.3), # surface albedo (0.1, 0.3)
    #("ALBSN", 0.4, 0.8), # snow surface albedo (0.4, 0.8)
    # soil parameters
    ("RSSA", 300, 430), # soil resistance (20, 1000)
    ("ths1", 0.2, 0.4), # theta_sat (0.15, 0.6)
    ("thr1", 0.005, 0.05), # theta_res (0.0, 0.1)
    ("ksat1", 0.15, 0.4), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha1", 0.6, 0.9), # multiplier on alpha (0.5, 1.5)
    ("npar1", 1.2, 1.25), # n (1.15, 1.3)
    ("ths2", 0.18, 0.225), # theta_sat (0.15, 0.6)
    ("thr2", 0.0, 0.025), # theta_res (0.0, 0.1)
    ("ksat2", -0.2, 0.2), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha2", 1.2, 1.45), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.2, 1.23), # n (1.15, 1.3)
    ("ths3", 0.15, 0.165), # theta_sat (0.15, 0.6)
    ("thr3", 0.01, 0.045), # theta_res (0.0, 0.1)
    ...
    ("R5", 75, 175), # radiation sensitivity (50, 200)
    ...
    ("VXYLEM_mm", 25.0, 50.0), # xylem volume (5, 80)
