...
param = [
    ...
    # soil parameters
    ("RSSA", 50, 900), # soil resistance (20, 1000)
    ("ths1", 0.35, 0.6), # theta_sat (0.15, 0.6)
    ("thr1", 0.0, 0.075), # theta_res (0.0, 0.1)
    ...
    ("alpha2", 0.8, 1.3), # multiplier on alpha (0.5, 1.5)
    ...
    ("GLMAX", 0.0025, 0.01), # stomatal conductance (0.001, 0.02)
    ...
    ("PSICR", -1.6, -1.2), # critical water potential (-3, -1)
    ...
    ("BETAROOT", 0.95, 0.99) # beta root coefficient (0.9, 0.999)
];
