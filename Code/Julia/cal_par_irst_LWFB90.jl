...
param = [
    # hydro parameters
    ("DRAIN", 0.1, 0.3), # drainage (0, 1)
    ("INFEXP", 0.35, 0.7), # infiltration exponent (0, 0.9)
    ("IDEPTH_m", 0.65, 0.85), # infiltration depth (m) (0.05, 1.0)
    # meteo parameters
    #("ALB", 0.15, 0.3), # surface albedo (0.1, 0.3)
    #("ALBSN", 0.4, 0.8), # snow surface albedo (0.4, 0.8)
    # soil parameters
    ("RSSA", 300, 800), # soil resistance (20, 1000)
    ("ths1", 0.5, 0.6), # theta_sat (0.15, 0.6)
    ("thr1", 0.0, 0.05), # theta_res (0.0, 0.1)
    ("ksat1", -0.2, 0.3), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha1", 0.6, 1.1), # multiplier on alpha (0.5, 1.5)
    ("npar1", 1.175, 1.29), # n (1.15, 1.3)
    ("ths2", 0.19, 0.23), # theta_sat (0.15, 0.6)
    ("thr2", 0.005, 0.02), # theta_res (0.0, 0.1)
    ("ksat2", -0.5, 0.0), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha2", 0.9, 1.25), # multiplier on alpha (0.5, 1.5)
    ("npar2", 1.2, 1.24), # n (1.15, 1.3)
    ("ths3", 0.2, 0.24), # theta_sat (0.15, 0.6)
    ("thr3", 0.0, 0.0075), # theta_res (0.0, 0.1)
    ("ksat3", -0.1, 0.35), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("alpha3", 0.6, 1.1), # multiplier on alpha (0.5, 1.5)
    ("npar3", 1.27, 1.3), # n (1.15, 1.3)
    # plant parameters
    ...
    ("CVPD", 0.75, 1.4), # vpd sensitivity (0.5, 3)
    ("R5", 60, 130), # radiation sensitivity (50, 200)
    #("T1", 6, 12), # low temperature threshold (5, 15)
    #("T2", 20, 35), # high temperature threshold (20, 35)
    ("PSICR", -1.6, -1.5), # critical water potential (-3, -1)
    ("FXYLEM", 0.15, 0.45), # aboveground xylem fraction (0.1, 0.5)
    ("MXKPL", 8.0, 12.0), # maximum plant conductivity (7, 30)
    ...
    ("MAXROOTDEPTH", -1.8, -1.3), # max rooting depth (-2, -0.8)
    ("BETAROOT", 0.96, 0.972) # beta root coefficient (0.9, 0.999)
];
