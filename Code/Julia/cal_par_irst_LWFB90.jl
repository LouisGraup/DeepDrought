...
param = [
    ...
    # soil parameters
    ("RSSA", 1, 1400), # soil resistance (1, 1500)
    ("ths1", 0.3, 1.2), # multiplier on theta_sat (0.5, 1.5)
    ("ksat1", -0.5, 0.5), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("ths2", 0.25, 0.7), # multiplier on theta_sat (0.5, 1.5)
    ("ksat2", -0.4, 0.25), # additive factor on log10(k_sat) (-0.5, 0.5)
    ("ths3", 0.25, 0.6), # multiplier on theta_sat (0.5, 1.5)
    ("ksat3", -0.4, 0.3), # additive factor on log10(k_sat) (-0.5, 0.5)
    # plant parameters
    ...
    ("CVPD", 1.0, 2.4), # vpd sensitivity (1, 3)
    ("R5", 200, 400), # radiation sensitivity (50, 400)
    ...
    ("MXRTLN", 100, 5000), # maximum root length (100, 6000)
    ("VXYLEM_mm", 5.0, 50.0), # xylem volume (5, 80)
    ("DISPERSIVITY_mm", 35.0, 50.0), # dispersivity coefficient (30, 50)
    ("MAXROOTDEPTH", -1.8, -0.6), # max rooting depth (-5, -0.5)
